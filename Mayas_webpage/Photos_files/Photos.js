// Created by iWeb 3.0.4 local-build-20130921

function createMediaStream_id4()
{return IWCreatePhotocast("http://mayadenton.github.io/Mayas_webpage/Photos_files/rss.xml",true);}
function initializeMediaStream_id4()
{createMediaStream_id4().load('http://mayadenton.github.io/Mayas_webpage',function(imageStream)
...
IWLayoutPhotoGrid('id4',new IWPhotoGridLayout(2,new IWSize(270,270),new IWSize(270,30),new IWSize(324,315),27,27,0,new IWSize(36,44)),new IWPhotoFrame([IWCreateImage('Photos_files/dots_ul.png'),IWCreateImage('Photos_files/dots_top.png'),IWCreateImage('Photos_files/dots_ur.png'),IWCreateImage('Photos_files/dots_right.png'),IWCreateImage('Photos_files/dots_lr.png'),IWCreateImage('Photos_files/dots_bottom.png'),IWCreateImage('Photos_files/dots_ll.png'),IWCreateImage('Photos_files/dots_left.png')],null,0,1.000000,74.000000,7.000000,74.000000,18.000000,92.000000,25.000000,92.000000,44.000000,438.000000,316.000000,438.000000,316.000000,null,null,null,0.100000),imageStream,range,null,null,1.000000,{backgroundColor:'rgb(0, 0, 0)',reflectionHeight:100,reflectionOffset:2,captionHeight:100,fullScreen:0,transitionIndex:2},'Media/slideshow.html','widget1','widget2','widget3')});}
